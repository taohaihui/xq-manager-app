            ...
            React.createElement(react_router_dom_1.Switch, null,
                ...
                router_1.menuRouter.map(function (item) {
                    ...
                    return (React.createElement(react_router_dom_1.Route, { exact: true, key: item.path, path: item.path, render: function (routeProps) {
                            ...
                            return (React.createElement(menuRoot_1.default, __assign({}, _this.props, routeProps, { collapsed: _this.state.collapsed, setCollapsed: _this.setCollapsed.bind(_this), setAuthInfo: _this.setAuthInfo.bind(_this), getAuth: _this.getAuth.bind(_this), menu: router_1.appConfig.menu, openKeys: [item.parent], selectedKeys: [item.path] }),
