            ...
            React.createElement(react_router_dom_1.Switch, null,
                router_1.otherRouter.map(function (item) {
                    ...
                    return (React.createElement(react_router_dom_1.Route, { exact: true, key: item.path, path: item.path, render: function (props) {
                            ...
                            return (React.createElement(C, __assign({}, props, { setAuthInfo: _this.setAuthInfo.bind(_this) })));
                        } }));
                }),
                router_1.menuRouter.map(function (item) {
                    ...
                    return (React.createElement(react_router_dom_1.Route, { exact: true, key: item.path, path: item.path, render: function (props) {
                            ...
                            return (React.createElement(menuRoot_1.default, __assign({}, _this.props, props, { collapsed: _this.state.collapsed, setCollapsed: _this.setCollapsed.bind(_this), setAuthInfo: _this.setAuthInfo.bind(_this), getAuth: _this.getAuth.bind(_this), menu: router_1.appConfig.menu, openKeys: [item.parent], selectedKeys: [item.path] }),
                                React.createElement(C, __assign({}, props, { setAuthInfo: _this.setAuthInfo.bind(_this) }))));
                        } }));
                }),
