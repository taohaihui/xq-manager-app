        ...
        return (React.createElement("div", { className: "layout-wrap-xq", style: {
            ...
            React.createElement("div", { style: {
                ...
                React.createElement("div", { className: "layout-header-xq", style: {
                    ...
                    React.createElement("div", { className: "logout-btn-xq", style: {
                            width: 30,
                            height: '100%',
                            position: 'absolute',
                            right: 0,
                        ...
                        React.createElement(antd_1.Icon, { style: { fontSize: 16, color: '#fff', cursor: 'pointer' }, type: "poweroff", onClick: this.handleLogOut.bind(this) })))),
