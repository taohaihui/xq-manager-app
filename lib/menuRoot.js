    ...
    MenuRoot.prototype.render = function () {
        return (React.createElement(antd_1.Layout, { className: "layout-wrap-xq", style: { height: '100%' } },
            ...
            React.createElement(antd_1.Layout, null,
                React.createElement(Header, { className: "layout-header-xq", style: { padding: 0 } },
                    ...
                    React.createElement("div", { style: { display: 'inline-block', width: 'calc(100% - 80px)', height: '100%', overflow: 'hidden' } }, this.props.header),
                    React.createElement("div", { style: { display: 'inline-block', width: 50, height: '100%', overflow: 'hidden' } },
                        React.createElement(antd_1.Tooltip, { title: "\u9000\u51FA\u767B\u5F55" },
                ...
                React.createElement("div", { id: "layout-content-xq", className: "layout-content-xq", style: { position: 'relative', padding: 10, background: '#ddd', height: 'calc(100% - 64px)' } },
